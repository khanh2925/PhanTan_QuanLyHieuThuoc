...
public class BangGiaDaoImpl
        extends AbstractGenericDaoImpl<BangGia, String>
        implements BangGiaDao {

    public BangGiaDaoImpl() {
        super(BangGia.class);
    }
    ...
    // ===== Chi tiết bảng giá (phương thức tiện ích nhúng trong BangGiaDao) =====
