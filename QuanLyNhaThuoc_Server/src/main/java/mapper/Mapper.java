...
public final class Mapper {
    ...
    private static Object mapKnownType(Object source, Class<?> targetClass) {
        ...
        if (targetClass == ChiTietPhieuTraDTO.class && source instanceof ChiTietPhieuTra entity) return toChiTietPhieuTraDTO(entity);
    ...
    private static ChiTietPhieuTraDTO toChiTietPhieuTraDTO(ChiTietPhieuTra ct) {
        ChiTietPhieuTraDTO dto = new ChiTietPhieuTraDTO();
        if (ct.getPhieuTra() != null) dto.setMaPhieuTra(ct.getPhieuTra().getMaPhieuTra());
        if (ct.getId() != null) {
            dto.setMaHoaDon(ct.getId().getMaHoaDon());
            dto.setMaLo(ct.getId().getMaLo());
        }
        if (ct.getChiTietHoaDon() != null) {
            ChiTietHoaDon cthd = ct.getChiTietHoaDon();
            if (cthd.getSanPham() != null) dto.setTenSanPham(cthd.getSanPham().getTenSanPham());
            if (cthd.getLoSanPham() != null) dto.setMaLo(cthd.getLoSanPham().getMaLo());
        }
