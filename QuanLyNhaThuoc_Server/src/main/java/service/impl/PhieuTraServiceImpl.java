...
public class PhieuTraServiceImpl implements PhieuTraService {
    ...
    @Override
    public PhieuTraDTO layPhieuTraDTOTheoMa(String maPhieuTra) {
        return Mapper.map(layPhieuTraTheoMa(maPhieuTra), PhieuTraDTO.class);
    }
    ...
    @Override
    public List<ChiTietPhieuTraDTO> timKiemChiTietBangMaPhieuTra(String maPhieuTra) {
        return Mapper.mapList(chiTietPhieuTraDao.timKiemChiTietBangMaPhieuTra(maPhieuTra), ChiTietPhieuTraDTO.class);
    }

    @Override
    public String capNhatTrangThaiGiaoDich(String maPhieuTra, String maHoaDon, String maLo, String maDonViTinh, entity.NhanVien nhanVien, int trangThaiMoi) {
        return phieuTraDao.capNhatTrangThai_GiaoDich(maPhieuTra, maHoaDon, maLo, maDonViTinh, nhanVien, trangThaiMoi);
    }

    @Override
    public boolean capNhatTrangThaiPhieuTra(String maPhieuTra, boolean daDuyet) {
        return phieuTraDao.capNhatTrangThaiPhieuTra(maPhieuTra, daDuyet);
    }
