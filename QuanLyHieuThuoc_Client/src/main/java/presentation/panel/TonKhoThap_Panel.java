...
public class TonKhoThap_Panel extends JPanel {
    ...
    private void loadLoaiSanPham() {
        ...
        List<String> danhSachLoai = svc.getDanhSachLoaiSanPham();
    ...
    private void loadDuLieu() {
        ...
        List<Object[]> danhSachSP = svc.getSanPhamTonKhoThap(nguong, loaiSP);
        ...
        for (int i = 0; i < danhSachSP.size(); i++) {
            ...
            double tbBan = svc.getTrungBinhBanNgay(maSP, SO_NGAY_TINH_TB);
            if (tbBan < 0.1)
        ...
        // Lấy NCC gợi ý
        Object[] nccGoiY = svc.getNhaCungCapGoiY(nguong);
