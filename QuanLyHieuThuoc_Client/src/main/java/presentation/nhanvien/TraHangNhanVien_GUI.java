...
public class TraHangNhanVien_GUI extends JPanel implements ActionListener {
	...
	private void xuLyTraHang(ActionEvent e) {
		...
		pt.setNhanVien(_tk != null ? new NhanVien(_tk.getMaNhanVien(), _tk.getTenNhanVien(), "Quản lý".equals(_tk.getVaiTro()), 1) : null);
		pt.setNgayLap(today);
