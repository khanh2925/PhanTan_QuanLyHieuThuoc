...
public class NhanVien_QL_GUI extends JPanel implements ActionListener {
	...
	public NhanVien_QL_GUI() {
		...
		try { lamMoiForm(); } catch (Exception ignored) {}
	...
	public void actionPerformed(ActionEvent e) {
		...
		// 4. LÀM MỚI
			...
			try { lamMoiForm(); } catch (Exception ex) { JOptionPane.showMessageDialog(this, "Lỗi: " + ex.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE); }
		}
	...
	private void setupKeyboardShortcuts() {
		...
		actionMap.put("lamMoi", new AbstractAction() {
			@Override
			public void actionPerformed(ActionEvent e) {
				try { lamMoiForm(); } catch (Exception ex) { JOptionPane.showMessageDialog(null, "Lỗi: " + ex.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE); }
			}
		});
	...
	private NhanVien getNhanVienFromForm(boolean isThemMoi) throws Exception {
		// 1. Mã NV
		String maNV;
		if (isThemMoi) {
	...
	private void lamMoiForm() throws Exception {
