...
import presentation.dialog.CapNhatQuyCachDongGoi_Dialog;
import presentation.dialog.ThemQuyCachDongGoi_Dialog;
...
public class QuyCachDongGoi_GUI extends JPanel {
    ...
    private ClientService qcdg_DAO;
    private ClientService sp_DAO;
    private ClientService dvt_DAO;
    ...
    public QuyCachDongGoi_GUI() {
        ...
        qcdg_DAO = new ClientService();
        sp_DAO = new ClientService();
        dvt_DAO = new ClientService();
