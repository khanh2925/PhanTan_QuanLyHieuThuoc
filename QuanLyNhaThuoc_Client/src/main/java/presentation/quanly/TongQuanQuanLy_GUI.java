...
public class TongQuanQuanLy_GUI extends JPanel implements ActionListener, MouseListener {
    ...
    private ClientService khachHangDAO;
    private ClientService thongKeDAO;
    private ClientService phieuTraDAO;
    private ClientService phieuHuyDAO;
    ...
    public TongQuanQuanLy_GUI(presentation.Main mainGUI) {
        ...
        khachHangDAO = hoaDonDAO;
        thongKeDAO = hoaDonDAO;
        phieuTraDAO = hoaDonDAO;
        phieuHuyDAO = hoaDonDAO;
        phieuNhapDAO = hoaDonDAO;
