		...
		btnClone.addActionListener(e -> {
			...
			for (Component c : parent.getComponents()) {
				if (c instanceof TraHangItemPanel p) {
					...
					if (it.getQuyCachDangChon() != null && it.getQuyCachDangChon().getDonViTinh() != null) {
		...
		cboDonViTinh.addActionListener(e -> {
			...
			for (Component c : parent.getComponents()) {
				if (c instanceof TraHangItemPanel p) {
					...
					if (p.item != item && it.getQuyCachDangChon() != null && it.getQuyCachDangChon().getDonViTinh() != null
							&& it.getQuyCachDangChon().getDonViTinh().getTenDonViTinh().equals(dvMoi)) {
						...
						if (item.getQuyCachDangChon() != null && item.getQuyCachDangChon().getDonViTinh() != null) {
