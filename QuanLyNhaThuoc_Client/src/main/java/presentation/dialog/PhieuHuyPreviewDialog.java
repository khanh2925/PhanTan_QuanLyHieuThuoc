...
public class PhieuHuyPreviewDialog extends JDialog {
    ...
    public PhieuHuyPreviewDialog(Window owner, PhieuHuyDTO ph) {
    ...
    private String buildHTML(PhieuHuyDTO ph) {
        ...
        if (ph.getChiTietPhieuHuyList() != null) {
            for (ChiTietPhieuHuyDTO ct : ph.getChiTietPhieuHuyList()) {

                LoSanPhamDTO lo = ct.getLoSanPham();

                String maLo = lo != null ? lo.getMaLo() : ct.getMaLo();
                String tenSP = lo != null ? lo.getTenSanPham() : "";
