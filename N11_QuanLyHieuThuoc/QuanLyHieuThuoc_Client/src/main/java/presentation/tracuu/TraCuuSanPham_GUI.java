...
public class TraCuuSanPham_GUI extends JPanel implements ActionListener {
    ...
    private List<SanPham> layDanhSachSanPham() {
        return svc.getAllSanPhamEntity();
    }
    ...
    private List<SanPham> timKiemSanPham(String tuKhoa) {
        return svc.searchSanPhamEntity(tuKhoa);
    }
    ...
    private List<LoSanPham> layDanhSachLoTheoSanPham(String maSanPham) {
        return svc.getLotsByProductEntity(maSanPham);
    }
    ...
    private List<QuyCachDongGoi> layDanhSachQuyCachTheoSanPham(String maSanPham) {
        return svc.getPackagingRulesByProduct(maSanPham);
    }
