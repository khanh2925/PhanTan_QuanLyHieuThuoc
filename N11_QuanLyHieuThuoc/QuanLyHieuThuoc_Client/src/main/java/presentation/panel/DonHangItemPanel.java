...
public class DonHangItemPanel extends JPanel {
    ...
    public DonHangItemPanel(
        ...
        this(item, stt, donViArr, heSoArr, giaArr, anhPath, listener, parentGUI, dsItem);
    }
    ...
    private boolean taoDongMoiChoLoKeTiep(int soLuongChoLoMoi) {
        ...
        LoSanPham loKe = null;
        try {
            List<?> lots = svc.getLotsByProduct(sp.getMaSanPham());
            for (Object o : lots) {
    ...
    public void capNhatGiaoDien() {
     ...
     // ==========================================================
        ...
        if (item.getKhuyenMai() != null) {
            ...
            String giaTriKMFormatted = (km.getHinhThuc() == HinhThucKM.GIAM_GIA_PHAN_TRAM)
            ...
            String chiTietTooltip = "<html>"
                    ...
                    + "<b>Hình thức:</b> " + (km.getHinhThuc() == HinhThucKM.GIAM_GIA_PHAN_TRAM ? "Giảm theo phần trăm" : "Giảm theo tiền mặt") + "<br>"
