...
import dao.iml.LichSuNhanVienDaoImpl;
...
public class TraCuuNhanVien_GUI extends JPanel {
	...
	private final NhanVienDaoImpl nvDAO;
	private final LichSuNhanVienDaoImpl lichSuDAO;
	...
	public TraCuuNhanVien_GUI() {
		...
		lichSuDAO = new LichSuNhanVienDaoImpl();
		initialize();
	}
