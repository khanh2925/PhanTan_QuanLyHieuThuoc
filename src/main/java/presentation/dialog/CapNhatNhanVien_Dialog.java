...
public class CapNhatNhanVien_Dialog extends JDialog {
    ...
    private TaiKhoanDaoImpl TaiKhoanDaoImpl;
    ...
    public CapNhatNhanVien_Dialog(Frame owner, TaiKhoan tkToUpdate) {
        ...
        this.TaiKhoanDaoImpl = new TaiKhoanDaoImpl();
        this.NhanVienDaoImpl = new NhanVienDaoImpl();
        initialize();
        populateData();
    }
    ...
    private void onLuuButtonClick() {
        try {
            ...
            if (!taiKhoanCanCapNhat.getTenDangNhap().equals(tenDangNhap)
                    && TaiKhoanDaoImpl.kiemTraTenDangNhapTonTai(tenDangNhap)) {
            ...
            // Cập nhật DB
            boolean nvOK = NhanVienDaoImpl.capNhatNhanVien(nv);
            boolean tkOK = TaiKhoanDaoImpl.capNhatTaiKhoan(taiKhoanCanCapNhat);
