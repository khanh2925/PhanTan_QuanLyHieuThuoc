...
public enum CommandType {
    ...
    TAIKHOAN_TIM_QUEN_MAT_KHAU,     // data: Object[] { String maNV, String tenNV, String sdt, LocalDate ngaySinh }
    TAIKHOAN_DAT_LAI_MAT_KHAU,      // data: Object[] { String maTaiKhoan, String matKhauMoi }
    ...
    KHUYENMAI_TAO_MA,
    KHUYENMAI_THEM_CHI_TIET_SP,      // data: Object[] { String maKM, String maSanPham }
    KHUYENMAI_XOA_CHI_TIET_SP,       // data: Object[] { String maKM, String maSanPham }
    ...
    // ==================== QuyCachDongGoi ====================
    QUYCACH_LAY_THEO_SAN_PHAM,       // data: String maSanPham
    QUYCACH_LAY_GOC_THEO_SAN_PHAM,   // data: String maSanPham
    QUYCACH_LAY_THEO_SAN_PHAM_VA_DVT,// data: Object[] { String maSanPham, String maDonViTinh }
    QUYCACH_LAY_TAT_CA,
    QUYCACH_THEM,
    QUYCACH_CAP_NHAT,
    QUYCACH_XOA,
    ...
    PHIEUTRA_LAY_CHI_TIET,          // data: String maPhieuTra
    ...
    PHIEUTRA_CAP_NHAT_TRANG_THAI_GIAO_DICH, // data: Object[] { maPT, maHD, maLo, maDVT, NhanVien, int trangThaiMoi }
    PHIEUTRA_CAP_NHAT_TRANG_THAI,   // data: Object[] { maPT, boolean daDuyet }
    PHIEUTRA_TAO_MA,
