...
public class PhieuHuyDaoImpl
        extends AbstractGenericDaoImpl<PhieuHuy, String>
        implements PhieuHuyDao {

    public PhieuHuyDaoImpl() {
    ...
    public int demSoPhieuHuyHomNayCuaNhanVien(String maNhanVien) {
        return doInTransaction(em -> {
            ...
            List<Number> result = em.createNativeQuery(
                    ...
                    "WHERE MaNhanVien = ? AND DATE(NgayLapPhieu) = CURRENT_DATE")
