...
public class ChiTietBangGiaDaoImpl
        extends AbstractGenericDaoImpl<ChiTietBangGia, ChiTietBangGia.Id>
        implements ChiTietBangGiaDao {

    public ChiTietBangGiaDaoImpl() {
