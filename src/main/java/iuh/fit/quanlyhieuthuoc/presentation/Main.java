package iuh.fit.quanlyhieuthuoc.presentation;
...
import iuh.fit.quanlyhieuthuoc.presentation.dialog.ThongTinCaNhan_Dialog;
import iuh.fit.quanlyhieuthuoc.presentation.nhanvien.BanHang_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.nhanvien.HuyHangNhanVien_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.nhanvien.ThongKeNhanVien_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.nhanvien.TongQuanNV_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.nhanvien.TraHangNhanVien_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.BangGia_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.DonViTinh_QL_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.KhachHang_NV_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.KhuyenMai_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.NhaCungCap_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.NhanVien_QL_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.QLTraHang_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.QL_HuyHang_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.QuanLySanPham_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.QuanLyPhieuNhap_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.ThongKeDoanhThu_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.quanly.ThongKeSanPham_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuBangGia_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuDonHang_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuDonTraHang_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuDonViTinh_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuKhachHang_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuKhuyenMai_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuNhaCungCap_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuNhanVien_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuPhieuHuy_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuPhieuNhap_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuSanPham_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.tracuu.TraCuuLoSanPham_GUI;
import iuh.fit.quanlyhieuthuoc.presentation.trogiup.*;
...
public class Main extends JFrame {
	...
	private iuh.fit.quanlyhieuthuoc.presentation.quanly.TongQuanQuanLy_GUI dashboardQL;
	private iuh.fit.quanlyhieuthuoc.presentation.nhanvien.TongQuanNV_GUI dashboardNV;
	...
	private void buildUI() { // ⬅️ DI CHUYỂN NỘI DUNG từ constructor mặc định vào đây
		...
		if (isQL) {
			dashboardQL = new iuh.fit.quanlyhieuthuoc.presentation.quanly.TongQuanQuanLy_GUI(this);
	...
	private JPanel createMenu() {
		...
		if (isQL) {
			...
			addSubmenuButton("thongke", "thongkenhanvien", "Thống kê nhân viên", "/resources/images/icon_nhan_vien.png",
					() -> new iuh.fit.quanlyhieuthuoc.presentation.quanly.ThongKeNhanVien_QL_GUI());
