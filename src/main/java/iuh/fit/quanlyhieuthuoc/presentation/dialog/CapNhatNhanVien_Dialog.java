...
public class CapNhatNhanVien_Dialog extends JDialog {
    ...
    public CapNhatNhanVien_Dialog(Frame owner, TaiKhoan tkToUpdate) {
        ...
        this.TaiKhoanRepositoryImpl = new TaiKhoanRepositoryImpl();
        this.NhanVienRepositoryImpl = new NhanVienRepositoryImpl();
        initialize();
        populateData();
    }
    ...
    private void onLuuButtonClick() {
        try {
            ...
            if (!taiKhoanCanCapNhat.getTenDangNhap().equals(tenDangNhap)
                    && TaiKhoanRepositoryImpl.kiemTraTenDangNhapTonTai(tenDangNhap)) {
            ...
            // Cập nhật DB
            boolean nvOK = NhanVienRepositoryImpl.capNhatNhanVien(nv);
            boolean tkOK = TaiKhoanRepositoryImpl.capNhatTaiKhoan(taiKhoanCanCapNhat);
