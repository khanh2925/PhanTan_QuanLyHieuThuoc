...
public class ThongTinCaNhan_Dialog extends JDialog {
    ...
    // DAO
    private NhanVienRepositoryImpl nhanVienDAO;
    private TaiKhoanRepositoryImpl taiKhoanDAO;
    ...
    public ThongTinCaNhan_Dialog(Frame owner, Runnable onUpdateCallback) {
        ...
        this.nhanVienDAO = new NhanVienRepositoryImpl();
        this.taiKhoanDAO = new TaiKhoanRepositoryImpl();
