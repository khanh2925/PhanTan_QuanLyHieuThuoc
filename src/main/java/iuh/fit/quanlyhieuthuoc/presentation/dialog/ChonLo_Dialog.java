...
public class ChonLo_Dialog extends JDialog implements ActionListener, MouseListener,ChangeListener {
    ...
    private java.util.Map<iuh.fit.quanlyhieuthuoc.core.entity.ChiTietPhieuNhap, Object> mapThongTinHienThi = null; // Map để lưu thông tin hiển thị
    ...
    public ChonLo_Dialog(Frame owner, SanPham sp, String maLoDeNghi, List<QuyCachDongGoi> dsQuyCach, QuyCachDongGoi quyCachGoc, List<ChiTietPhieuNhap> dsLoHienTai, java.util.Map<iuh.fit.quanlyhieuthuoc.core.entity.ChiTietPhieuNhap, Object> mapThongTinHienThi) {
