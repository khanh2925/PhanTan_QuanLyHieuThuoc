...
public class TongQuanNV_GUI extends JPanel implements ActionListener, MouseListener {
	...
	@SuppressWarnings("unused")
	private ChiTietHoaDonRepositoryImpl chiTietHoaDonDAO;
	 ...
	 */
	public TongQuanNV_GUI(iuh.fit.quanlyhieuthuoc.presentation.Main mainGUI) {
		...
		chiTietHoaDonDAO = new ChiTietHoaDonRepositoryImpl();
