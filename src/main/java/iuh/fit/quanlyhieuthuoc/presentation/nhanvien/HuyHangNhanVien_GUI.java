...
import iuh.fit.quanlyhieuthuoc.presentation.component.input.*;
import iuh.fit.quanlyhieuthuoc.presentation.component.label.*;
import iuh.fit.quanlyhieuthuoc.presentation.component.button.*;
...
import iuh.fit.quanlyhieuthuoc.presentation.panel.HuyHangItemPanel;
import iuh.fit.quanlyhieuthuoc.presentation.dialog.DialogChonLo;
import iuh.fit.quanlyhieuthuoc.presentation.dialog.PhieuHuyPreviewDialog;
...
public class HuyHangNhanVien_GUI extends JPanel implements ActionListener {
	...
	private final PhieuHuyRepositoryImpl phieuHuyDAO = new PhieuHuyRepositoryImpl();
	private final QuyCachDongGoiRepositoryImpl quyCachDAO = new QuyCachDongGoiRepositoryImpl();
