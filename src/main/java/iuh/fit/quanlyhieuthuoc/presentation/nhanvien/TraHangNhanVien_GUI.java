...
import iuh.fit.quanlyhieuthuoc.presentation.component.button.TaoButtonNhanh;
import iuh.fit.quanlyhieuthuoc.presentation.component.input.TaoJtextNhanh;
import iuh.fit.quanlyhieuthuoc.presentation.component.label.TaoLabelNhanh;
import iuh.fit.quanlyhieuthuoc.infrastructure.persistence.ChiTietHoaDonRepositoryImpl;
import iuh.fit.quanlyhieuthuoc.infrastructure.persistence.ChiTietPhieuTraRepositoryImpl;
...
import iuh.fit.quanlyhieuthuoc.infrastructure.persistence.PhieuTraRepositoryImpl;
...
import iuh.fit.quanlyhieuthuoc.presentation.dialog.ChonSanPhamTraDialog;
import iuh.fit.quanlyhieuthuoc.presentation.dialog.HoaDonPickerDialog;
import iuh.fit.quanlyhieuthuoc.presentation.dialog.PhieuTraPreviewDialog;
import iuh.fit.quanlyhieuthuoc.presentation.panel.TraHangItemPanel;
...
public class TraHangNhanVien_GUI extends JPanel implements ActionListener {
	...
	private final HoaDonRepositoryImpl hoaDonDAO;
	private final ChiTietHoaDonRepositoryImpl cthdDAO;
	private final PhieuTraRepositoryImpl ptDAO;
	private final ChiTietPhieuTraRepositoryImpl ctptDAO;
	private final QuyCachDongGoiRepositoryImpl qcdgDAO;
	...
	public TraHangNhanVien_GUI() {
		...
		cthdDAO = new ChiTietHoaDonRepositoryImpl();
		ptDAO = new PhieuTraRepositoryImpl();
		ctptDAO = new ChiTietPhieuTraRepositoryImpl();
		qcdgDAO = new QuyCachDongGoiRepositoryImpl();
	...
	private void xuLyTimHDTheoSDTKH() {
		...
		KhachHang kh = new KhachHangRepositoryImpl().timKhachHangTheoSoDienThoai(sdt);
		if (kh == null) {
