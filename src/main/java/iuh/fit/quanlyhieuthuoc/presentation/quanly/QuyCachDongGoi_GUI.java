...
import iuh.fit.quanlyhieuthuoc.presentation.dialog.CapNhatQuyCachDongGoi_Dialog;
import iuh.fit.quanlyhieuthuoc.presentation.dialog.ThemQuyCachDongGoi_Dialog;
...
public class QuyCachDongGoi_GUI extends JPanel {
    ...
    private QuyCachDongGoiRepositoryImpl qcdg_DAO;
    private SanPhamRepositoryImpl sp_DAO;
    private DonViTinhRepositoryImpl dvt_DAO;
    ...
    public QuyCachDongGoi_GUI() {
        ...
        qcdg_DAO = new QuyCachDongGoiRepositoryImpl();
        sp_DAO = new SanPhamRepositoryImpl();
        dvt_DAO = new DonViTinhRepositoryImpl();
