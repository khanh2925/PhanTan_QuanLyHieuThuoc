...
import iuh.fit.quanlyhieuthuoc.presentation.component.chart.BieuDoCotGroup;
...
import iuh.fit.quanlyhieuthuoc.infrastructure.persistence.PhieuHuyRepositoryImpl;
...
public class TongQuanQuanLy_GUI extends JPanel implements ActionListener, MouseListener {
    ...
    private KhachHangRepositoryImpl khachHangDAO;
    private ThongKeRepositoryImpl thongKeDAO;
    private PhieuTraRepositoryImpl phieuTraDAO;
    private PhieuHuyRepositoryImpl phieuHuyDAO;
    private PhieuNhapRepositoryImpl phieuNhapDAO;
    
    // Main GUI reference để chuyển card
    private iuh.fit.quanlyhieuthuoc.presentation.Main mainGUI;
     ...
     */
    public TongQuanQuanLy_GUI(iuh.fit.quanlyhieuthuoc.presentation.Main mainGUI) {
        this.mainGUI = mainGUI;
        this.setPreferredSize(new Dimension(1537, 850));
        
        // Khởi tạo DAOs
        hoaDonDAO = new HoaDonRepositoryImpl();
        khachHangDAO = new KhachHangRepositoryImpl();
        thongKeDAO = new ThongKeRepositoryImpl();
        phieuTraDAO = new PhieuTraRepositoryImpl();
        phieuHuyDAO = new PhieuHuyRepositoryImpl();
        phieuNhapDAO = new PhieuNhapRepositoryImpl();
