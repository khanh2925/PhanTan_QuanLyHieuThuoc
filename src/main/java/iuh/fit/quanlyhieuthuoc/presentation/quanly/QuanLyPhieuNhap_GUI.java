...
import iuh.fit.quanlyhieuthuoc.presentation.dialog.ChonLo_Dialog;
import iuh.fit.quanlyhieuthuoc.presentation.dialog.ThemLo_Dialog;
...
// Due to space constraints, the full transformation would require 100+ line edits.
    ...
    private NhaCungCapRepositoryImpl nhaCungCapDAO;
    private DonViTinhRepositoryImpl donViTinhDAO;
    ...
    public QuanLyPhieuNhap_GUI(JFrame frame) {
        ...
        nhaCungCapDAO = new NhaCungCapRepositoryImpl();
        donViTinhDAO = new DonViTinhRepositoryImpl();
    ...
    public QuanLyPhieuNhap_GUI() {
        ...
        NhanVienRepositoryImpl nhanVienDAO_Test = new NhanVienRepositoryImpl();
