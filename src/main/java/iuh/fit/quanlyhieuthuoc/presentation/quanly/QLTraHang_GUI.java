...
public class QLTraHang_GUI extends JPanel implements ActionListener, MouseListener {
	...
	private PhieuTraRepositoryImpl pt_dao;
	private ChiTietPhieuTraRepositoryImpl ctpt_dao;
	...
	private void initialize() {
		...
		pt_dao = new PhieuTraRepositoryImpl();
		ctpt_dao = new ChiTietPhieuTraRepositoryImpl();
	...
	private void NhapKho() {
		...
		LoSanPhamRepositoryImpl LoSanPhamRepositoryImpl = new LoSanPhamRepositoryImpl();
		LoSanPham loSanPham = LoSanPhamRepositoryImpl.timLoTheoMa(maLo);
		...
		if (loSanPham != null) {
			...
			QuyCachDongGoiRepositoryImpl qcDAO = new QuyCachDongGoiRepositoryImpl();
