...
import iuh.fit.quanlyhieuthuoc.presentation.dialog.DialogChonSanPhamApDung;
...
public class KhuyenMai_GUI extends JPanel implements ActionListener {
	...
	private KhuyenMaiRepositoryImpl kmDAO = new KhuyenMaiRepositoryImpl();
	private ChiTietKhuyenMaiSanPhamRepositoryImpl ctkmDAO = new ChiTietKhuyenMaiSanPhamRepositoryImpl();
	private SanPhamRepositoryImpl spDAO = new SanPhamRepositoryImpl();
	private QuyCachDongGoiRepositoryImpl qcDAO = new QuyCachDongGoiRepositoryImpl();
