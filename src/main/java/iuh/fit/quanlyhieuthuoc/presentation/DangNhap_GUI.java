...
import iuh.fit.quanlyhieuthuoc.presentation.dialog.QuenMatKhau_Dialog;
...
import iuh.fit.quanlyhieuthuoc.infrastructure.persistence.DataPreloaderRepositoryImpl;
...
public class DangNhap_GUI extends JFrame {
	...
	// Khởi tạo Repository
	private final TaiKhoanRepository taiKhoanRepository = new TaiKhoanRepositoryImpl();
	...
	public DangNhap_GUI() {
		...
		new DataPreloaderRepositoryImpl().preloadAllData();
	}
	...
	/**
	 * 💡 HÀM XỬ LÝ SỰ KIỆN ĐĂNG NHẬP (Dùng Repository và Session)
	 */
	private void xuLyDangNhap() {
		...
		// 2. Gọi Repository để xác thực
		TaiKhoan taiKhoan = taiKhoanRepository.dangNhap(tenDangNhap, matKhau); // Hàm đã có join NhanVien
