...
import iuh.fit.quanlyhieuthuoc.presentation.component.chart.BieuDoTronLegend;
import iuh.fit.quanlyhieuthuoc.presentation.component.chart.DuLieuBieuDoTron;
...
public class ThongKeTheoLoai_Panel extends JPanel {
    ...
    // DAO
    private ThongKeRepositoryImpl thongKeDAO = new ThongKeRepositoryImpl();
