...
public class DonHangItemPanel extends JPanel {
    ...
    public DonHangItemPanel(
            ...
            LoSanPhamRepositoryImpl loSanPhamDao,
            QuyCachDongGoiRepositoryImpl quyCachDongGoiDao
    ) {
        this.item = item;
        this.stt = stt;
    ...
    public void capNhatGiaoDien() {
     ...
     // ==========================================================
        ...
        if (item.getKhuyenMai() != null) {
            ...
            String giaTriKMFormatted = (km.getHinhThuc() == iuh.fit.quanlyhieuthuoc.core.enums.HinhThucKM.GIAM_GIA_PHAN_TRAM)
            ...
            String chiTietTooltip = "<html>"
                    ...
                    + "<b>Hình thức:</b> " + (km.getHinhThuc() == iuh.fit.quanlyhieuthuoc.core.enums.HinhThucKM.GIAM_GIA_PHAN_TRAM ? "Giảm theo phần trăm" : "Giảm theo tiền mặt") + "<br>"
