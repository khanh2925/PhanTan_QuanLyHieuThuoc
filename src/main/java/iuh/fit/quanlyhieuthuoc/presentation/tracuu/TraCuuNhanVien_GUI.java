...
import iuh.fit.quanlyhieuthuoc.infrastructure.persistence.LichSuNhanVienRepositoryImpl;
...
public class TraCuuNhanVien_GUI extends JPanel {
	...
	private final NhanVienRepositoryImpl nvDAO;
	private final LichSuNhanVienRepositoryImpl lichSuDAO;
	...
	public TraCuuNhanVien_GUI() {
		...
		nvDAO = new NhanVienRepositoryImpl();
		lichSuDAO = new LichSuNhanVienRepositoryImpl();
		initialize();
	}
	...
	private void xuatExcelDayDu() {
		...
		for (String maNV : dsMaNVCanXuat) {
			...
			dsHuyXuat.addAll(lichSuDAO.layLichSuHuyTheoNhanVien(maNV, null, null));
		}
