...
public class TraCuuDonTraHang_GUI extends JPanel implements ActionListener {
	...
	// DAO
	private final PhieuTraRepositoryImpl phieuTraDAO;
	private final ChiTietPhieuTraRepositoryImpl chiTietPhieuTraDAO;
	...
	public TraCuuDonTraHang_GUI() {
		...
		chiTietPhieuTraDAO = new ChiTietPhieuTraRepositoryImpl();
		initialize();
	}
