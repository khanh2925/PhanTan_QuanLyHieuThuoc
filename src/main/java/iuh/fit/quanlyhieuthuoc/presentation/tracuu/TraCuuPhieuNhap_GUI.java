...
public class TraCuuPhieuNhap_GUI extends JPanel implements ActionListener, MouseListener {
    ...
    private PhieuNhapRepositoryImpl phieuNhapRepositoryImpl;
    ...
    public TraCuuPhieuNhap_GUI(JFrame mainFrame) {
        ...
        phieuNhapRepositoryImpl = new PhieuNhapRepositoryImpl();
    ...
    private void setupKeyboardShortcuts() {
        ...
        actionMap.put("xemHoaDon", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                PhieuNhap phieuNhap = phieuNhapRepositoryImpl.timPhieuNhapTheoMa(maPhieuNhap);
                if (phieuNhap != null) {
        ...
        if (e.getSource().equals(tblPhieuNhap)) {
            if (e.getClickCount() == 2) {
                ...
                if (row != -1) {
                    ...
                    PhieuNhap pn = phieuNhapRepositoryImpl.timPhieuNhapTheoMa(maPN);
                    if (pn != null) {
                        hienThiHoaDon(pn);
                    }
                }
    ...
    private void taiDuLieuPhieuNhap() {
        ...
        List<PhieuNhap> listPN = phieuNhapRepositoryImpl.layDanhSachPhieuNhap();
    ...
    private void xuLyTimKiem() {
        ...
        modelPhieuNhap.setRowCount(0);
        List<PhieuNhap> listPN = phieuNhapRepositoryImpl.timKiemPhieuNhap(keyword, tuNgay, denNgay);
