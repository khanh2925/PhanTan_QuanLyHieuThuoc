...
// Import Entity & DAO
import iuh.fit.quanlyhieuthuoc.infrastructure.persistence.BangGiaRepositoryImpl;
import iuh.fit.quanlyhieuthuoc.infrastructure.persistence.ChiTietBangGiaRepositoryImpl;
...
public class TraCuuBangGia_GUI extends JPanel implements ActionListener {
    ...
    private BangGiaRepositoryImpl bangGiaDAO;
    private ChiTietBangGiaRepositoryImpl chiTietBangGiaDAO;
    ...
    public TraCuuBangGia_GUI() {
        ...
        // 1. Init DAO
        bangGiaDAO = new BangGiaRepositoryImpl();
        chiTietBangGiaDAO = new ChiTietBangGiaRepositoryImpl();
