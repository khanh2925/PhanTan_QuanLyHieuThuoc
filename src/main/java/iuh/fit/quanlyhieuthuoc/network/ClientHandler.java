...
import iuh.fit.quanlyhieuthuoc.core.service.*;
import iuh.fit.quanlyhieuthuoc.core.service.impl.*;
        ...
        try {
            switch (cmd) {
                ...
                case KHACHHANG_LAY_THEO_MA -> {
                    KhachHang kh = khachHangService.timKhachHangTheoMa((String) data);
                    response.setSuccess(kh != null);
                    response.setData(kh);
                    response.setMessage(kh != null ? "Tìm thấy" : "Không tìm thấy khách hàng");
                }
                case KHACHHANG_LAY_THEO_SDT -> {
                    KhachHang kh = khachHangService.timKhachHangTheoSoDienThoai((String) data);
                    response.setSuccess(kh != null);
                    response.setData(kh);
                    response.setMessage(kh != null ? "Tìm thấy" : "Không tìm thấy khách hàng");
                }
                ...
                case KHACHHANG_THEM -> {
                    boolean ok = khachHangService.themKhachHang((KhachHang) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Thêm khách hàng thành công" : "Thêm khách hàng thất bại");
                }
                case KHACHHANG_CAP_NHAT -> {
                    boolean ok = khachHangService.capNhatKhachHang((KhachHang) data);
                    response.setSuccess(ok);
                ...
                case NHANVIEN_LAY_THEO_MA -> {
                    NhanVien nv = nhanVienService.timNhanVienTheoMa((String) data);
                ...
                case NHANVIEN_THEM -> {
                    boolean ok = nhanVienService.themNhanVien((NhanVien) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Thêm nhân viên thành công" : "Thêm nhân viên thất bại");
                }
                case NHANVIEN_CAP_NHAT -> {
                    boolean ok = nhanVienService.capNhatNhanVien((NhanVien) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Cập nhật thành công" : "Cập nhật thất bại");
                }
                case NHANVIEN_XOA -> {
                ...
                case TAIKHOAN_DANG_NHAP -> {
                    ...
                    Object[] params = (Object[]) data;
                    TaiKhoan tk = taiKhoanService.dangNhap((String) params[0], (String) params[1]);
                ...
                case TAIKHOAN_TAO_MOI -> {
                    boolean ok = taiKhoanService.taoTaiKhoan((TaiKhoan) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Tạo tài khoản thành công" : "Tạo tài khoản thất bại");
                }
                case TAIKHOAN_CAP_NHAT -> {
                    boolean ok = taiKhoanService.capNhatTaiKhoan((TaiKhoan) data);
                    response.setSuccess(ok);
                ...
                case SANPHAM_THEM -> {
                    boolean ok = sanPhamService.themSanPham((SanPham) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Thêm sản phẩm thành công" : "Thêm sản phẩm thất bại");
                }
                case SANPHAM_CAP_NHAT -> {
                    boolean ok = sanPhamService.capNhatSanPham((SanPham) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Cập nhật thành công" : "Cập nhật thất bại");
                }
                case SANPHAM_XOA -> {
                ...
                case HOADON_LAY_THEO_MA -> {
                    HoaDon hd = hoaDonService.layHoaDonTheoMa((String) data);
                ...
                case HOADON_THEM -> {
                    boolean ok = hoaDonService.themHoaDon((HoaDon) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Tạo hóa đơn thành công" : "Tạo hóa đơn thất bại");
                }
                case HOADON_CAP_NHAT -> {
                    boolean ok = hoaDonService.capNhatHoaDon((HoaDon) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Cập nhật thành công" : "Cập nhật thất bại");
                }
                ...
                case KHUYENMAI_LAY_THEO_MA -> {
                    KhuyenMai km = khuyenMaiService.layKhuyenMaiTheoMa((String) data);
                ...
                case KHUYENMAI_THEM -> {
                    boolean ok = khuyenMaiService.themKhuyenMai((KhuyenMai) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Thêm khuyến mãi thành công" : "Thêm khuyến mãi thất bại");
                }
                case KHUYENMAI_CAP_NHAT -> {
                    boolean ok = khuyenMaiService.capNhatKhuyenMai((KhuyenMai) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Cập nhật thành công" : "Cập nhật thất bại");
                }
                case KHUYENMAI_XOA -> {
                ...
                case LOSANPHAM_LAY_THEO_MA -> {
                    LoSanPham lo = loSanPhamService.layLoSanPhamTheoMa((String) data);
                ...
                case LOSANPHAM_THEM -> {
                    boolean ok = loSanPhamService.themLoSanPham((LoSanPham) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Thêm lô sản phẩm thành công" : "Thêm lô sản phẩm thất bại");
                }
                case LOSANPHAM_CAP_NHAT -> {
                    boolean ok = loSanPhamService.capNhatLoSanPham((LoSanPham) data);
                    response.setSuccess(ok);
                    response.setMessage(ok ? "Cập nhật thành công" : "Cập nhật thất bại");
                }
                ...
                case PHIEUNHAP_LAY_THEO_MA -> {
                    PhieuNhap pn = phieuNhapService.layPhieuNhapTheoMa((String) data);
                ...
                case PHIEUNHAP_THEM -> {
                    boolean ok = phieuNhapService.themPhieuNhap((PhieuNhap) data);
                    response.setSuccess(ok);
