...
public class NhaCungCapRepositoryImpl
        extends AbstractGenericRepositoryImpl<NhaCungCap, String>
        implements NhaCungCapRepository {

    public NhaCungCapRepositoryImpl() {
