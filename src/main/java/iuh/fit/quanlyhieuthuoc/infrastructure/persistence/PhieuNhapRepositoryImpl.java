...
public class PhieuNhapRepositoryImpl
        extends AbstractGenericRepositoryImpl<PhieuNhap, String>
        implements PhieuNhapRepository {

    public PhieuNhapRepositoryImpl() {
