...
import iuh.fit.quanlyhieuthuoc.core.repository.ChiTietPhieuTraRepository;

import java.util.List;

public class ChiTietPhieuTraRepositoryImpl
        extends AbstractGenericRepositoryImpl<ChiTietPhieuTra, ChiTietPhieuTra.Id>
        implements ChiTietPhieuTraRepository {

    public ChiTietPhieuTraRepositoryImpl() {
