...
public class TaiKhoanRepositoryImpl
        extends AbstractGenericRepositoryImpl<TaiKhoan, String>
    ...
    public String taoMaTaiKhoanTuDong() {
        ...
        return doInTransaction(em -> {
            ...
            List<String> result = em.createNativeQuery(
                    "SELECT TOP 1 MaTaiKhoan FROM TaiKhoan WHERE MaTaiKhoan LIKE ? ORDER BY MaTaiKhoan DESC")
