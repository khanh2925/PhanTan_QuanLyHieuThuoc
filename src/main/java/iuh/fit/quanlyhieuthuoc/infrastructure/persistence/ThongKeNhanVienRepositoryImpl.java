...
import iuh.fit.quanlyhieuthuoc.core.repository.ThongKeNhanVienRepository;
 ...
 * Không extend AbstractGenericRepositoryImpl vì không có entity cụ thể.
 */
public class ThongKeNhanVienRepositoryImpl implements ThongKeNhanVienRepository {
