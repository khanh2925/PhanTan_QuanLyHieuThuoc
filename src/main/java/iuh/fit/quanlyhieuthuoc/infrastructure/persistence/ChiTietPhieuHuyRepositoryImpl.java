...
import iuh.fit.quanlyhieuthuoc.core.repository.ChiTietPhieuHuyRepository;

import java.util.List;

public class ChiTietPhieuHuyRepositoryImpl
        extends AbstractGenericRepositoryImpl<ChiTietPhieuHuy, ChiTietPhieuHuy.Id>
        implements ChiTietPhieuHuyRepository {

    public ChiTietPhieuHuyRepositoryImpl() {
